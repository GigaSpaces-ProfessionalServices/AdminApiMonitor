...
md %INSTALL_DIR%\gs-monitor
SET INSTALL_DIR=%INSTALL_DIR%\gs-monitor
xcopy target\gs-monitor.jar %INSTALL_DIR%
...
::ECHO java -Dproperties=%INSTALL_DIR%\admin-api.properties -Dlog.file=%LOGFILE% -Dlogback.configurationFile=%INSTALL_DIR%\%LOGGING_CONFIG%  -jar gs-monitor.jar %CSV%
java -Dproperties=%INSTALL_DIR%\admin-api.properties -Dlog.file=%LOGFILE% -Dlogback.configurationFile=%INSTALL_DIR%\%LOGGING_CONFIG%  -jar gs-monitor.jar %CSV%
::chmod +x run.sh
::./run.sh
